...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 02:09:13 2024
...
class TradeManager():
    ...
    def create_trades(self, trades_to_make):
        for t in trades_to_make:
            trade_info = self.api.place_trade(t['pair'], t['units'], t['time'])
            if trade_info is not None:
                trade_info['pair'] = t['pair']
                trade_info['units'] = t['units']
                self.log_message(f"TradeManager:Opened {trade_info}")
            else:
